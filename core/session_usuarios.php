...
class USERsession extends DBAbstractModel{
    ...
    public function authenticated()
    {
        ...
        if (isset($_SESSION['nombre']) && isset($_SESSION['email']) && isset($_SESSION['authenticated'])) {
 ...
 /**
    ...
    public function login($username, $password)
    {
        ...
        try {
            ...
            $resultData         = null;
            #$encrypted_password = md5($password); To enccrypt password an make a comparation
            $this->query = "SELECT id, nombre, apellido, email, clave FROM login WHERE email = '".$username."' AND clave= '".$password."'";
